...
cp -r docs-translation/ja target/jekyll-webapp/ja/docs
cp -r docs-translation/zh-Hans target/jekyll-webapp/zh-Hans/docs

# rename main branch to latest
# old versions should be stored on version number branches in the translation repo
mv target/jekyll-webapp/ja/docs/ja target/jekyll-webapp/ja/docs/latest
mv target/jekyll-webapp/zh-Hans/docs/zh-Hans target/jekyll-webapp/zh-Hans/docs/latest
