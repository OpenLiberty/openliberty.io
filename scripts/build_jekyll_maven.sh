...
# # After cloning docs, use Antora to build the doc pages
# echo "Cloning the docs repository using Antora:"
# antora --fetch playbook.yml

# # # Copy the contents generated by Antora to the website folder
# mkdir -p src/main/content/docs
# cp -r build src/main/content/docs
...
# # Copy the contents generated by Antora to the website folder
mkdir -p target/jekyll-webapp/docstest
cp -r build/site/ target/jekyll-webapp/docstest
