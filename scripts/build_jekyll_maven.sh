...
# Clone docs repo Antora - change me
...
echo "Cloning the docs repository using the Antora playbook:"
antora --fetch --stacktrace src/main/content/docs/production-antora-playbook.yml
