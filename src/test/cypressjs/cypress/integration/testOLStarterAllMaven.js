...
describe('Test Open Liberty Starter - Maven', () => {
    ...
    it('Test zip file is downloaded with maven', () => {
        ...
        for (let i = 0; i < jakarta_mp_versions.length; i++) {
            ...
            const appname = javase_appname[jdkVer]+'-m-'+convertNum2Str[jktVer]+'-'+convertNum2Str[mpVer];
            cy.log(`appname ` + appname);

            cy.downloadAndUnZipFileMaven(appname, jdkVer, jktVer, mpVer);
        }
    });

    // Jakarta 9.1, MP 5.0
    it('Test Open Liberty Starter - JDK' + jdkVer + ' Jakarta 9.1, MP 5.0', () => {
        const appname = javase_appname[jdkVer]+'-m-'+convertNum2Str["9.1"]+'-'+convertNum2Str["5.0"];
    ...
    it('Test Open Liberty Starter - JDK' + jdkVer + ' Jakarta 9.1, MP None', () => {
        const appname = javase_appname[jdkVer]+'-m-'+convertNum2Str["9.1"]+'-'+convertNum2Str["None"];
        cy.log('appname ' + appname);
        const javahome = javase_javahome[jdkVer];
    ...
    it('Test Open Liberty Starter - JDK' + jdkVer + ' Jakarta 8.0, MP 4.1 ', () => {
        const appname = javase_appname[jdkVer]+'-m-'+convertNum2Str["8.0"]+'-'+convertNum2Str["4.1"];
        const javahome = javase_javahome[jdkVer];

        cy.runMVNWLibertyDev(appname, javahome, 120000);
        cy.checkLocalSplashPage();
        cy.runMVNWLibertyStop(appname, javahome);
    });
    ...
    it('Test Open Liberty Starter - JDK' + jdkVer + ' Jakarta 8.0, MP 3.3', () => {
        const appname = javase_appname[jdkVer]+'-m-'+convertNum2Str["8.0"]+'-'+convertNum2Str["3.3"];
        const javahome = javase_javahome[jdkVer];
    ...
    it('Test Open Liberty Starter - JDK' + jdkVer + ' Jakarta 8.0, MP 2.2', () => {
        const appname = javase_appname[jdkVer]+'-m-'+convertNum2Str["8.0"]+'-'+convertNum2Str["2.2"];
        const javahome = javase_javahome[jdkVer];
