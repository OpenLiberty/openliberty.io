...
|===
[#+cloudant/ssl/keyStore+]*cloudant > ssl > keyStore*
...
|===
[#+cloudant/ssl/keyStore/keyEntry+]*cloudant > ssl > keyStore > keyEntry*
...
|===
[#+cloudant/ssl/trustStore+]*cloudant > ssl > trustStore*
...
+Server will scan for keystore file changes at the polling interval and update if the keystore file has detectable changes.+
|===
[#+cloudant/ssl/trustStore/keyEntry+]*cloudant > ssl > trustStore > keyEntry*
