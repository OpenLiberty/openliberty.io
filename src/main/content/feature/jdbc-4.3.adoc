...
To enable the Java Database Connectivity 4.3 feature, add the following element declaration inside the featureManager element in your server.xml file:
...
If you are developing a feature that depends on the Java Database Connectivity 4.3 feature, include the following item in the Subsystem-Content header in the feature manifest file for your new feature:
