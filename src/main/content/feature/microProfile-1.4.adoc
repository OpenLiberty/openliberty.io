...
To enable the MicroProfile 1.4 feature, add the following element declaration inside the featureManager element in your server.xml file:
...
If you are developing a feature that depends on the MicroProfile 1.4 feature, include the following item in the Subsystem-Content header in the feature manifest file for your new feature:
