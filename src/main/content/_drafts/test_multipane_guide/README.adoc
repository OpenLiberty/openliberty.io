...
//     IBM Corporation
//
:projectid: multipane-guide-example
:page-projectid: multipane-guide-example
:page-layout: guide-multipane
:page-duration: 30 minutes
:page-releasedate: 2018-05-02
...
The `@GET` annotation on the method indicates that this method it to be called for the HTTP `GET`
...
[discrete]
=== EndpointTest.java
what you'll learn=3, what youll learn=3
[source,java,role="codecolumn"]
----
include::finish/src/test/java/it/io/openliberty/guides/rest/EndpointTest.java[tags=**;!comment]
----
...
[discrete]
=== Pom.xml
creating-a-jax-rs-application=20,Creating the JAX-RS resource=20
[source,xml,role="codecolumn"]
----
...
[discrete]
=== Server.xml
building-and-running-the-application=1,testing-the-service=5,Great work! You're done!=11,great work! youre done!=11
[source,xml,role="codecolumn"]
----
include::finish/src/main/liberty/config/server.xml[]
----