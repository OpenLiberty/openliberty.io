...
By adopting a two-layered approach to building Docker images, Spring Boot development builds benefit from a thin application layer.
This speeds-up iterative development and minimizing deployment time.
