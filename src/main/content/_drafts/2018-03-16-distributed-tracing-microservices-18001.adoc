...
seo-description: FILL THIS IN
blog_description: FILL THIS IN
---
:description: FILL THIS IN in Open Liberty 18.0.0.1.
...
* MicroProfile 1.3:
** <<mpopentracing,Enable distributed tracing with MicroProfile OpenTracing 1.0>>
** <<mpopenapi,MicroProfile OpenAPI 1.0>>
** <<mprestclient,MicroProfile Rest Client 1.0>>
** <<mpmetrics,MicroProfile Metrics 1.1>>
** <<mpconfig,MicroProfile Config 1.2>>
* What else is new?
...
The MicroProfile OpenAPI 1.0 feature (`mpOpenAPI-1.0`) is an implementation of the http://download.eclipse.org/microprofile/microprofile-open-api-1.0/microprofile-openapi-spec.html[MicroProfile OpenAPI 1.0 specification]. To try it out, add this feature to your `server.xml` list of features:
...
This new feature builds from mpMetrics-1.0.  It implements the MicroProfile Metrics 1.1 spec, which added explicit support for reusing metrics in different parts of your app, and adds the ability to configure it using mpConfig-1.2. 
...
PUBLISH UPDATED VERSION ON OL.IO?
