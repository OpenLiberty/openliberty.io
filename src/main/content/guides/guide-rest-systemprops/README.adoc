...
:page-description: This is the short description for the REST service guide
:page-tags: ['REST', 'Getting Started']
:page-permalink: /guides/rest-service-guide
